...
| M13 — Omnichannel Reporting & Polish | 4 packets (M13.1–M13.4) | In progress — M13.1 unified sales reporting shipped (backend `6e47139` + frontend `e2eef27`); M13.2 revenue analytics shipped (backend `4a34b76` + frontend `d03a518`); M13.3 POS today widgets shipped (backend `cff1004` + frontend `8da7809`); M13.4 not started |
