...
| M13 — Omnichannel Reporting & Polish | Both tracks (convergence) | In progress — M13.1 unified sales reporting shipped (backend `6e47139` + frontend `e2eef27`); M13.2–M13.4 not started |
